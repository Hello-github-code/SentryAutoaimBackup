...
struct Status : detail::Base<OrtStatus> {
  ...
  explicit Status(
    OrtStatus *
      status);  ///< Takes ownership of OrtStatus instance returned from the C API. Must be non-null
...
struct Env : detail::Base<OrtEnv> {
  ...
  Env(OrtLoggingLevel logging_level,
      const char *logid,
...
struct ConstSessionOptionsImpl : Base<T> {
  ...
  SessionOptions Clone()
    const;  ///< Creates and returns a copy of this SessionOptions object. Wraps OrtApi::CloneSessionOptions
...
struct SessionOptionsImpl : ConstSessionOptionsImpl<T> {
  ...
  SessionOptionsImpl &SetCustomThreadCreationOptions(
    void *
      ort_custom_thread_creation_options);  ///< Wraps OrtApi::SessionOptionsSetCustomThreadCreationOptions
...
struct Session : detail::SessionImpl<OrtSession> {
  ...
  Session(
    ...
    OrtPrepackedWeightsContainer
      *prepacked_weights_container);  ///< Wraps OrtApi::CreateSessionWithPrepackedWeightsContainer
  Session(const Env &env,
  ...
  Session(
    ...
    const SessionOptions &options,
    OrtPrepackedWeightsContainer *
      prepacked_weights_container);  ///< Wraps OrtApi::CreateSessionFromArrayWithPrepackedWeightsContainer
...
struct ConstValueImpl : Base<T> {
  ...
  /// </summary>
  template <typename R>
  void GetOpaqueData(const char *domain,
  ...
  bool HasValue()
    const;  /// < Return true if OrtValue contains data and returns false if the OrtValue is a None

  size_t GetCount()
    const;  // If a non tensor, returns 2 for map and N for sequence, where N is the number of elements
  ...
  void GetStringTensorContent(void *buffer,
...
struct Value : detail::ValueImpl<OrtValue> {
   ...
   * \param type The data type.
   */
  static Value CreateTensor(OrtAllocator *allocator,
                            const int64_t *shape,
                            size_t shape_len,
                            ONNXTensorElementDataType type);
  ...
  template <typename T>
  static Value CreateOpaque(const char *domain,
                            const char *type_name,
...
struct Op : detail::Base<OrtOp> {
  ...
  static Op Create(const OrtKernelInfo *info,
                   const char *op_name,
                   const char *domain,
                   int version,
...
struct CustomOpApi {
   ...
   */
  [[deprecated("use Ort::Value::GetTensorTypeAndShape()")]] OrtTensorTypeAndShapeInfo *
   ...
   */
  [[deprecated("use Ort::TensorTypeAndShapeInfo::GetElementCount()")]] size_t
   ...
   * This interface is redundant.
   */
  [[deprecated("use Ort::TensorTypeAndShapeInfo::GetElementType()")]] ONNXTensorElementDataType
  GetTensorElementType(const OrtTensorTypeAndShapeInfo *info);

  /** \deprecated use Ort::TensorTypeAndShapeInfo::GetDimensionsCount()
   * [[deprecated]]
   * This interface is redundant.
   */
  [[deprecated("use Ort::TensorTypeAndShapeInfo::GetDimensionsCount()")]] size_t GetDimensionsCount(
   ...
   * This interface is redundant.
   */
  [[deprecated("use Ort::TensorTypeAndShapeInfo::GetShape()")]] void GetDimensions(
    _In_ const OrtTensorTypeAndShapeInfo *info,
   ...
   */
  [[deprecated("Do not use")]] void SetDimensions(OrtTensorTypeAndShapeInfo *info,
   ...
   */
  template <typename T>
  [[deprecated("use Ort::Value::GetTensorMutableData()")]] T *GetTensorMutableData(
   ...
   */
  template <typename T>
  [[deprecated("use Ort::Value::GetTensorData()")]] const T *GetTensorData(
    _Inout_ const OrtValue *value);

  /** \deprecated use Ort::Value::GetTensorMemoryInfo()
   * [[deprecated]]
   * This interface is redundant.
   */
  [[deprecated("use Ort::Value::GetTensorMemoryInfo()")]] const OrtMemoryInfo *GetTensorMemoryInfo(
   ...
   * This interface is redundant.
   */
  [[deprecated("use Ort::TensorTypeAndShapeInfo::GetShape()")]] std::vector<int64_t> GetTensorShape(
   ...
   */
  [[deprecated("use TensorTypeAndShapeInfo")]] void ReleaseTensorTypeAndShapeInfo(
   ...
   * This interface is redundant.
   */
  [[deprecated("use Ort::KernelContext::GetInputCount")]] size_t KernelContext_GetInputCount(
   ...
   * This interface is redundant.
   */
  [[deprecated("use Ort::KernelContext::GetInput")]] const OrtValue *KernelContext_GetInput(
   ...
   * This interface is redundant.
   */
  [[deprecated("use Ort::KernelContext::GetOutputCount")]] size_t KernelContext_GetOutputCount(
    const OrtKernelContext *context);
   ...
   * This interface is redundant.
   */
  [[deprecated("use Ort::KernelContext::GetOutput")]] OrtValue *KernelContext_GetOutput(
    OrtKernelContext *context, _In_ size_t index, _In_ const int64_t *dim_values, size_t dim_count);

  /** \deprecated use Ort::KernelContext::GetGPUComputeStream
   * [[deprecated]]
   * This interface is redundant.
   */
  [[deprecated("use Ort::KernelContext::GetGPUComputeStream")]] void *
  KernelContext_GetGPUComputeStream(const OrtKernelContext *context);
   ...
   * This interface is not exception safe.
   */
  [[deprecated("use Ort::Op")]] OrtOp *CreateOp(
   ...
   */
  template <
    typename T>  // T is only implemented for std::vector<float>, std::vector<int64_t>, float, int64_t, and string
  [[deprecated("use Ort::KernelInfo::GetAttribute")]] T KernelInfoGetAttribute(
   ...
   * This interface is not exception safe
   */
  [[deprecated("use Ort::KernelInfo::Copy")]] OrtKernelInfo *CopyKernelInfo(
    _In_ const OrtKernelInfo *info);
   ...
   * This interface is not exception safe
   */
  [[deprecated("use Ort::KernelInfo")]] void ReleaseKernelInfo(
