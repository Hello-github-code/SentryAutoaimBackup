...
#define STATE_SEND_ID_RIGHT 0x106  //
#define STATE_SEND_ID_LEFT 0x107  //

#define DATA_SEND_ID_RIGHT 0x108   //
#define DATA_SEND_ID_LEFT 0x109   //

#define IMU_TIME_RECEIVE_ID_RIGHT 0x100    // right时间ID
#define IMU_TIME_RECEIVE_ID_LEFT 0x101    // left时间ID

#define IMU_RECEIVE_ID_RIGHT 0x102         // 四元数ID
#define IMU_RECEIVE_ID_LEFT 0x104         // 四元数 ID

#define IMU_RECEIVE_ID 0x0FF         // 四元数ID

#define MODE_RECEIVE_ID_RIGHT 0x110        // 模式ID
#define MODE_RECEIVE_ID_LEFT 0x111        // 模式ID
