...
namespace rmos_transporter_l
{
    ...
    public:
        CommNode(const std::string &node_name, const rclcpp::NodeOptions &options) : Node(node_name, options)
        {
            ...
            this->color_pub_ = this->create_publisher<rmos_interfaces::msg::Color>("/color_info_l", rclcpp::SensorDataQoS());
            this->bs_pub_ = this->create_publisher<rmos_interfaces::msg::BulletSpeed>("/bs_info_l", rclcpp::SensorDataQoS());
